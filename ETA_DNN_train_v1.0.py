    ...
    def creat(self):
        ...
        with tf.variable_scope("rnn") as scope1:
            ...
            with tf.variable_scope("readTrainData")as testData_scope:
                ...
                dataset = dataset.batch(100).repeat(1)
...
obj = regression_dnn("eta_test_137.tfrecords", "eta_train_137.tfrecords",'./etaModel_DNN_V1.0/model.ckpt',"error_v1.0.log")
